/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=production --strict-vars=false` (hash: bef184f60556ce6f353337f1c66e4167)
// Runtime types generated with workerd@1.20260911.1 2026-09-11 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	LINE_EVENTS: Queue;
	CAMPAIGN_EVENTS: Queue;
	ASSETS: Fetcher;
	LINE_DELIVERY_MODE: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LINE_DELIVERY_MODE" | "PUBLIC_BASE_URL" | "OPENAI_MODEL" | "ENVIRONMENT" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "ADMIN_EMAIL" | "AUTH_MODE" | "AUTH_CHANNEL" | "BINGX_API_KEY" | "BINGX_SECRET_KEY" | "ADMIN_TOKEN" | "LINE_CHANNEL_SECRET" | "LINE_CHANNEL_ACCESS_TOKEN" | "OPENAI_API_KEY">> {}
}
